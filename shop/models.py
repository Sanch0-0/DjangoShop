...
class Clothes(models.Model):
    ...
    price = models.DecimalField(verbose_name="price", max_digits=7, decimal_places=2, default=1)
    discount = models.SmallIntegerField(verbose_name="discount", default=0, blank=True)
    uploaded = models.DateTimeField(verbose_name="upload date", auto_now_add=True)
